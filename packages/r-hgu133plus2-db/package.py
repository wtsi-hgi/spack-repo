...
class RHgu133plus2Db(RPackage):
	...
	bioc = "hgu133plus2.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/hgu133plus2.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/hgu133plus2.db/hgu133plus2.db_3.13.0.tar.gz"]

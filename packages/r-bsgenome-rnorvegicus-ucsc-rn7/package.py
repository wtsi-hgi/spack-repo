...
class RBsgenomeRnorvegicusUcscRn7(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Rnorvegicus.UCSC.rn7_1.4.3.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Rnorvegicus.UCSC.rn7/BSgenome.Rnorvegicus.UCSC.rn7_1.4.3.tar.gz"]

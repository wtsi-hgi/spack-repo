...
class RInteractivedisplay(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/interactiveDisplay_1.40.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/interactiveDisplay/interactiveDisplay_1.40.0.tar.gz"]

...
class RRnamodrData(RPackage):
	...
	bioc = "RNAmodR.Data" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/RNAmodR.Data_1.16.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/RNAmodR.Data/RNAmodR.Data_1.16.0.tar.gz"]

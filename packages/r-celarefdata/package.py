...
class RCelarefdata(RPackage):
	...
	bioc = "celarefData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/celarefData_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/celarefData/celarefData_1.20.0.tar.gz"]

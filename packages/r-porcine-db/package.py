...
class RPorcineDb(RPackage):
	...
	bioc = "porcine.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/porcine.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/porcine.db/porcine.db_3.13.0.tar.gz"]

...
class PyPandas(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        depends_on("python@3.9:3.12", when="@2.2:")
        depends_on("python@3.9:3.11", when="@2.1")
        ...
        depends_on("python@:3.7", when="@0.23.4:0.25.1")
    ...
    with default_args(type="build"):
        ...
        depends_on("py-cython@3.0.5:3.0", when="@2.2:")
        ...
        # pandas <=2.0 imports pkg_resources which was removed in setuptools 71
        depends_on("py-setuptools@61:70", when="@2.0")
        depends_on("py-setuptools@51:70", when="@1.3.2:1")
        depends_on("py-setuptools@38.6:70", when="@1.3.0:1.3.1")
        depends_on("py-setuptools@24.2:70", when="@:1.2")
    ...
    with default_args(type="run"):
        with when("+performance"):
            ...
            depends_on("py-numexpr@2.8.0:2.10.1", when="@2.1:")

...
class RRagene20stprobesetDb(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/ragene20stprobeset.db_8.8.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/ragene20stprobeset.db/ragene20stprobeset.db_8.8.0.tar.gz"]

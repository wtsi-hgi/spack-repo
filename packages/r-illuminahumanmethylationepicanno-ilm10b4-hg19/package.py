...
class RIlluminahumanmethylationepicannoIlm10b4Hg19(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/IlluminaHumanMethylationEPICanno.ilm10b4.hg19_0.6.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/IlluminaHumanMethylationEPICanno.ilm10b4.hg19/IlluminaHumanMethylationEPICanno.ilm10b4.hg19_0.6.0.tar.gz"]

	version("0.6.0", md5="2d0c05917bcbf9ba1e354380d4e17a77", url="https://www.bioconductor.org/packages/release/data/annotation/src/contrib/IlluminaHumanMethylationEPICanno.ilm10b4.hg19_0.6.0.tar.gz")

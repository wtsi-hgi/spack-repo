...
class RYgs98probe(RPackage):
	...
	bioc = "ygs98probe" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/ygs98probe_2.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/ygs98probe/ygs98probe_2.18.0.tar.gz"]

...
class RArabidopsisDb0(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/arabidopsis.db0_3.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/arabidopsis.db0/arabidopsis.db0_3.18.0.tar.gz"]

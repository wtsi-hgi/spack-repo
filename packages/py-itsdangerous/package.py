...
class PyItsdangerous(PythonPackage):
    ...
    pypi = "itsdangerous/itsdangerous-2.2.0.tar.gz"
    ...
    depends_on("python@3.6:", when="@2.0:", type=("build", "run"))
    ...
    def install_test(self):
        with working_dir("spack-test", create=True):
            ...
            python("-c", "import itsdangerous, hashlib; itsdangerous.Signer('k').sign('data')")

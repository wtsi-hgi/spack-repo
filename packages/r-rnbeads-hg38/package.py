...
class RRnbeadsHg38(RPackage):
	...
	bioc = "RnBeads.hg38" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/RnBeads.hg38_1.34.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/RnBeads.hg38/RnBeads.hg38_1.34.0.tar.gz"]

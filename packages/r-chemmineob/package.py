...
class RChemmineob(RPackage):
	...
	bioc = "ChemmineOB" 
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/ChemmineOB_1.40.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/ChemmineOB/ChemmineOB_1.40.0.tar.gz"]

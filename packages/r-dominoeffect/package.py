...
class RDominoeffect(RPackage):
	...
	bioc = "DominoEffect" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/DominoEffect_1.22.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/DominoEffect/DominoEffect_1.22.0.tar.gz"]

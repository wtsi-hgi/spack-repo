...
class RBiobase(RPackage):
	...
	bioc = "Biobase"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Biobase_2.62.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Biobase/Biobase_2.62.0.tar.gz"]

...
class RChipexoqual(RPackage):
	...
	bioc = "ChIPexoQual" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ChIPexoQual_1.26.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ChIPexoQual/ChIPexoQual_1.26.0.tar.gz"]

...
class RPlyr(RPackage):
	...
	cran = "plyr"
	# Compatibility alias: environment requests 1.1.4, map to 1.8.4 source
	version("1.1.4", sha256="60b522d75961007658c9806f8394db27989f1154727cb0bb970062c96ec9eac5")
	...
	def url_for_version(self, version):
		# Redirect 1.1.4 to the 1.8.4 source tarball for compatibility
		if str(version) == "1.1.4":
			return "https://cran.r-project.org/src/contrib/plyr_1.8.4.tar.gz"

...
class RMalariaDb0(RPackage):
	...
	version("3.18.0", md5="6f71b4ac69ae5237f3f5e1337d5073d7", url="https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/malaria.db0_3.18.0.tar.gz")

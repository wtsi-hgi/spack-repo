...
class RBsgenomeEcoliNcbi20080805(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Ecoli.NCBI.20080805_1.3.1000.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Ecoli.NCBI.20080805/BSgenome.Ecoli.NCBI.20080805_1.3.1000.tar.gz"]

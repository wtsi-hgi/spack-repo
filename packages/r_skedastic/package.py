...
class RSkedastic(RPackage):
	...
	homepage = "https://github.com/tjfarrar/skedastic"
	cran = "skedastic" 

	version("2.0.2", md5="2c0b166da8c89b01849e806a4d629291")
	...
	depends_on("r-bazar@1.0.11:", type=("build", "run"))
	depends_on("r-quadprog@1.5.8:", type=("build", "run"))
	depends_on("r-inflection@1.3.5:", type=("build", "run"))
	depends_on("r-rfast@2.0.6:", type=("build", "run"))
	depends_on("r-caret@6.0.90:", type=("build", "run"))
	depends_on("r-matrix@1.4.1:", type=("build", "run"))
	depends_on("r-quadprogxt@0.0.5:", type=("build", "run"))
	depends_on("r-slam@0.1.49:", type=("build", "run"))
	depends_on("r-roi@1:", type=("build", "run"))
	depends_on("r-osqp@0.6.0.5:", type=("build", "run"))
	depends_on("r-mgcv@1.8.40:", type=("build", "run"))
	depends_on("r-roi-plugin-qpoases@1.0.2:", type=("build", "run"))

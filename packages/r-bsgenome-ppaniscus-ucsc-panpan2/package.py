...
class RBsgenomePpaniscusUcscPanpan2(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Ppaniscus.UCSC.panPan2_1.4.3.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Ppaniscus.UCSC.panPan2/BSgenome.Ppaniscus.UCSC.panPan2_1.4.3.tar.gz"]

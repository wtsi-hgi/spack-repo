...
class RPdHuex10StV2(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.huex.1.0.st.v2_3.14.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.huex.1.0.st.v2/pd.huex.1.0.st.v2_3.14.1.tar.gz"]

...
class RCopdsexualdimorphismData(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/COPDSexualDimorphism.data_1.38.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/COPDSexualDimorphism.data/COPDSexualDimorphism.data_1.38.0.tar.gz"]

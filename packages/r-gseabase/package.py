...
class RGseabase(RPackage):
	...
	bioc = "GSEABase"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/GSEABase_1.64.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/GSEABase/GSEABase_1.64.0.tar.gz"]

...
try:
    ...
    class CompilerPackage(Package):
        """Fallback for older Spack releases lacking CompilerPackage."""

        pass

from spack.pkg.sanger.hgi.llvm import LlvmDetection
...
class LlvmAmdgpu(CMakePackage, LlvmDetection, CompilerPackage):
    ...
    variant("openmp", default=True, description="Build and expose the OpenMP runtime libraries")

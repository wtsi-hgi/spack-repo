...
class RMgug4122aDb(RPackage):
	...
	bioc = "mgug4122a.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/mgug4122a.db_3.2.3.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/mgug4122a.db/mgug4122a.db_3.2.3.tar.gz"]

...
class RRbcbook1(RPackage):
	...
	bioc = "RbcBook1" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/RbcBook1_1.70.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/RbcBook1/RbcBook1_1.70.0.tar.gz"]

...
class RPdRta10(RPackage):
	...
	bioc = "pd.rta.1.0" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.rta.1.0_3.12.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.rta.1.0/pd.rta.1.0_3.12.2.tar.gz"]

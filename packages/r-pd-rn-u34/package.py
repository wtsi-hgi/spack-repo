...
class RPdRnU34(RPackage):
	...
	bioc = "pd.rn.u34" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.rn.u34_3.12.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.rn.u34/pd.rn.u34_3.12.0.tar.gz"]

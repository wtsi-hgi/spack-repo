...
class PyStatsmodels(PythonPackage):
    ...
    variant("scipysvd", default=False, description="Use scipy.linalg instead of numpy")
    ...
    def patch(self):
        if "+scipysvd" in self.spec:
            filter_file("from scipy import stats", "from scipy import stats, linalg", "statsmodels/base/model.py")
            filter_file("np.linalg.pinv", "linalg.pinv", "statsmodels/base/model.py")

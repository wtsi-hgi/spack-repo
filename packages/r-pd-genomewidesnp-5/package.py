...
class RPdGenomewidesnp5(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.genomewidesnp.5_3.14.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.genomewidesnp.5/pd.genomewidesnp.5_3.14.1.tar.gz"]

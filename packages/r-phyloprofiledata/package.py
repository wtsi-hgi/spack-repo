...
class RPhyloprofiledata(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/PhyloProfileData_1.16.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/PhyloProfileData/PhyloProfileData_1.16.0.tar.gz"]

...
class RBsgenomeTgondiiToxodb70(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Tgondii.ToxoDB.7.0_0.99.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Tgondii.ToxoDB.7.0/BSgenome.Tgondii.ToxoDB.7.0_0.99.1.tar.gz"]

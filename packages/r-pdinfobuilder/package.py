...
class RPdinfobuilder(RPackage):
	...
	bioc = "pdInfoBuilder" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/pdInfoBuilder_1.66.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/pdInfoBuilder/pdInfoBuilder_1.66.0.tar.gz"]

	version("1.66.0", md5="67c0c8df22f95792e50c1e6c4b6eba2a")

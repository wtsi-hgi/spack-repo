...
class RMetaboliteidmapping(RPackage):
    ...
    version(
        ...
        url="https://www.bioconductor.org/packages/3.21/data/annotation/src/contrib/metaboliteIDmapping_1.0.0.tar.gz",
    )
    ...
    def url_for_version(self, version):
        """Construct Bioconductor source URL for this package.

        Use the release path; older versions will be served from Archive by
        Bioconductor's redirect logic.
        """
        return "https://bioconductor.org/packages/release/bioc/src/contrib/{0}_{1}.tar.gz".format(
            self.bioc, version
        )

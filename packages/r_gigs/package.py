...
class RGigs(RPackage):
    ...
    Convert between anthropometric measures and z-scores/centiles in multiple
    growth standards, and classify fetal, newborn, and child growth accordingly.
    """
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("r-gamlss-dist")
        depends_on("r-rlang")
        depends_on("r-vctrs@0.4.0:")
        depends_on("r-cli")

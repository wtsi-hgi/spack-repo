...
class RRegressor(RPackage):
	...
	version("3.0.2", md5="8eacb6c16f35f209f8b0c9248aa9c9c5")

	depends_on("r@4.1:", type=("build", "run"))
	depends_on("r-dt@0.27:", type=("build", "run"))
	depends_on("r-pls@2.8.1:", type=("build", "run"))
	...
	depends_on("r-loader@1.1.3:", type=("build", "run"))

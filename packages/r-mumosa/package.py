...
class RMumosa(RPackage):
	...
	bioc = "mumosa" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/mumosa_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/mumosa/mumosa_1.10.0.tar.gz"]

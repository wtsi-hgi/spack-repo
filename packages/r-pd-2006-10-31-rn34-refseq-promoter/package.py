...
class RPd20061031Rn34RefseqPromoter(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/pd.2006.10.31.rn34.refseq.promoter_0.99.3.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/pd.2006.10.31.rn34.refseq.promoter/pd.2006.10.31.rn34.refseq.promoter_0.99.3.tar.gz",
    ]

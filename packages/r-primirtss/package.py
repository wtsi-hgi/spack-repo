...
class RPrimirtss(RPackage):
	...
	bioc = "primirTSS" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/primirTSS_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/primirTSS/primirTSS_1.20.0.tar.gz"]

	version("1.20.0", md5="ead295f564f0e3c4c9d9c8bfa568e745")

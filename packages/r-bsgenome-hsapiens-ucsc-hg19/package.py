...
class RBsgenomeHsapiensUcscHg19(RPackage):
    ...
    url = "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Hsapiens.UCSC.hg19_1.4.3.tar.gz"
    ...
    depends_on("r-bsgenome@1.33.5:1.77", type=("build", "run"), when="@1.4.0")

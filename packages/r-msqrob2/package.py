...
class RMsqrob2(RPackage):
	...
	bioc = "msqrob2" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/msqrob2_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/msqrob2/msqrob2_1.10.0.tar.gz"]

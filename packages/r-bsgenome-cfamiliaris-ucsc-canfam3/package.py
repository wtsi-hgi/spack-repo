...
class RBsgenomeCfamiliarisUcscCanfam3(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Cfamiliaris.UCSC.canFam3_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Cfamiliaris.UCSC.canFam3/BSgenome.Cfamiliaris.UCSC.canFam3_1.4.0.tar.gz"]

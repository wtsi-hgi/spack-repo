...
class RAffydata(RPackage):
	...
	bioc = "affydata"
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/affydata_1.50.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/affydata/affydata_1.50.0.tar.gz"]

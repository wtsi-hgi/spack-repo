...
class RDnacopy(RPackage):
	...
	bioc = "DNAcopy"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/DNAcopy_1.76.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/DNAcopy/DNAcopy_1.76.0.tar.gz"]

...
class RBsgenomeRnorvegicusUcscRn4Masked(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Rnorvegicus.UCSC.rn4.masked_1.3.99.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Rnorvegicus.UCSC.rn4.masked/BSgenome.Rnorvegicus.UCSC.rn4.masked_1.3.99.tar.gz"]

	version("1.3.99", md5="7e2ea7df588b6b10515e07ea3868c568")

...
class RHierfstat(RPackage):
    """Estimates hierarchical F-statistics from haploid or diploid genetic data with any numbers of levels in the hierarchy, following the algorithm of Yang."""

    homepage = "https://github.com/jgx65/hierfstat"
    cran = "hierfstat"

...
class ROccugene(RPackage):
	...
	bioc = "occugene" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/occugene_1.62.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/occugene/occugene_1.62.0.tar.gz"]

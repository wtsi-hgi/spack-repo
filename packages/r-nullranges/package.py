...
class RNullranges(RPackage):
	...
	bioc = "nullranges" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/nullranges_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/nullranges/nullranges_1.8.0.tar.gz"]

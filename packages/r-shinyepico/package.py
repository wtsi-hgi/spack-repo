...
class RShinyepico(RPackage):
	...
	bioc = "shinyepico" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/shinyepico_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/shinyepico/shinyepico_1.10.0.tar.gz"]

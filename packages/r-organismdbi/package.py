...
class ROrganismdbi(RPackage):
	...
	with default_args(type=("build", "run")):
		...
		depends_on("r@2.14.0:")
		depends_on("r-biocinstaller", when="@:1.22")
		depends_on("r-biocmanager", when="@1.24:")
		depends_on("r-biocgenerics@0.15.10:")
		depends_on("r-annotationdbi@1.33.15:")

		depends_on("r-genomicfeatures@1.23.31:")
		depends_on("r-genomicfeatures@1.39.4:", when="@1.32:")
		depends_on("r-genomicfeatures@:1.50", when="@:1.36")
		depends_on("r-genomicfeatures@:1.60", when="@:1.44")
		depends_on("r-genomicfeatures@1.61.4:", when="@1.52:")
		
		depends_on("r-biobase")
		depends_on("r-genomicranges")
		depends_on("r-genomicranges@1.31.13:", when="@1.22:")
		depends_on("r-genomicranges@1.61.1:", when="@1.52:")
		depends_on("r-graph")
		...
		depends_on("r-seqinfo", when="@1.52:")

...
class RClariomsmousetranscriptclusterDb(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/clariomsmousetranscriptcluster.db_8.8.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/clariomsmousetranscriptcluster.db/clariomsmousetranscriptcluster.db_8.8.0.tar.gz"]

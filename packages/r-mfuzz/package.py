...
class RMfuzz(RPackage):
	...
	bioc = "Mfuzz" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Mfuzz_2.62.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Mfuzz/Mfuzz_2.62.0.tar.gz"]

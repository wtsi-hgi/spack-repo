...
class RBsgenomeDmelanogasterUcscDm3Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Dmelanogaster.UCSC.dm3.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Dmelanogaster.UCSC.dm3.masked/BSgenome.Dmelanogaster.UCSC.dm3.masked_1.3.99.tar.gz",
    ]

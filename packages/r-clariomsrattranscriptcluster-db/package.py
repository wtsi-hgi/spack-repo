...
class RClariomsrattranscriptclusterDb(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/clariomsrattranscriptcluster.db_8.8.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/clariomsrattranscriptcluster.db/clariomsrattranscriptcluster.db_8.8.0.tar.gz"]

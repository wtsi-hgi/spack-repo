...
class RHtratfocusDb(RPackage):
	...
	bioc = "htratfocus.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/htratfocus.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/htratfocus.db/htratfocus.db_3.13.0.tar.gz"]

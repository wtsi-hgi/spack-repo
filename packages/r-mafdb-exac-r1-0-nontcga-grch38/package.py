...
class RMafdbExacR10NontcgaGrch38(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/MafDb.ExAC.r1.0.nonTCGA.GRCh38_3.10.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/MafDb.ExAC.r1.0.nonTCGA.GRCh38/MafDb.ExAC.r1.0.nonTCGA.GRCh38_3.10.0.tar.gz"]

...
class RPdMoex10StV1(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.moex.1.0.st.v1_3.14.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.moex.1.0.st.v1/pd.moex.1.0.st.v1_3.14.1.tar.gz"]

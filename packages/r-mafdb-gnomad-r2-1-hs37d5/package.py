...
class RMafdbGnomadR21Hs37d5(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/MafDb.gnomAD.r2.1.hs37d5_3.10.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/MafDb.gnomAD.r2.1.hs37d5/MafDb.gnomAD.r2.1.hs37d5_3.10.0.tar.gz"]

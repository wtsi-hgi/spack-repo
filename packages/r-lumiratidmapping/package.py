...
class RLumiratidmapping(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/lumiRatIDMapping_1.10.0.tar.gz", "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/lumiRatIDMapping/lumiRatIDMapping_1.10.0.tar.gz"]

	version("1.10.0", sha256="f0a5b8580d2c3a7f428a70ab8895589ed4112672f62c85ccc488b23efb6060b4")

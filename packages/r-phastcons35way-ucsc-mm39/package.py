...
class RPhastcons35wayUcscMm39(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/phastCons35way.UCSC.mm39_3.16.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/phastCons35way.UCSC.mm39/phastCons35way.UCSC.mm39_3.16.0.tar.gz"]

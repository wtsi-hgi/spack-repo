...
class RHivcdnavantwout03(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/HIVcDNAvantWout03_1.42.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/HIVcDNAvantWout03/HIVcDNAvantWout03_1.42.0.tar.gz"]

...
class RBovineDb0(RPackage):
	...
	bioc = "bovine.db0" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/bovine.db0_3.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/bovine.db0/bovine.db0_3.18.0.tar.gz"]

...
class RGghumanmethcancerpanelv1Db(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/GGHumanMethCancerPanelv1.db_1.4.1.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/GGHumanMethCancerPanelv1.db/GGHumanMethCancerPanelv1.db_1.4.1.tar.gz",
    ]

...
class RMmdiff2(RPackage):
	...
	bioc = "MMDiff2" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MMDiff2_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MMDiff2/MMDiff2_1.30.0.tar.gz"]

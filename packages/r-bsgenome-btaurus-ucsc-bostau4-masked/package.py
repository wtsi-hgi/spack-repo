...
class RBsgenomeBtaurusUcscBostau4Masked(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Btaurus.UCSC.bosTau4.masked_1.3.99.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Btaurus.UCSC.bosTau4.masked/BSgenome.Btaurus.UCSC.bosTau4.masked_1.3.99.tar.gz"]

	version("1.3.99", md5="7c5294349c7061adfb3948bc5659afeb")

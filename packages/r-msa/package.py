...
class RMsa(RPackage):
	...
	bioc = "msa" 
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/msa_1.34.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/msa/msa_1.34.0.tar.gz"]

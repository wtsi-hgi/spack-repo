...
class ROmicade4(RPackage):
	...
	bioc = "omicade4" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/omicade4_1.42.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/omicade4/omicade4_1.42.0.tar.gz"]

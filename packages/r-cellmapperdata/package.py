...
class RCellmapperdata(RPackage):
	...
	bioc = "CellMapperData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/CellMapperData_1.28.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/CellMapperData/CellMapperData_1.28.0.tar.gz"]

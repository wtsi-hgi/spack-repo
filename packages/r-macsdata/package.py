...
class RMacsdata(RPackage):
	...
	bioc = "MACSdata" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/MACSdata_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/MACSdata/MACSdata_1.10.0.tar.gz"]

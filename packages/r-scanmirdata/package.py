...
class RScanmirdata(RPackage):
	...
	bioc = "scanMiRData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/scanMiRData_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/scanMiRData/scanMiRData_1.8.0.tar.gz"]

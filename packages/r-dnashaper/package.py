...
class RDnashaper(RPackage):
	...
	bioc = "DNAshapeR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/DNAshapeR_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/DNAshapeR/DNAshapeR_1.30.0.tar.gz"]

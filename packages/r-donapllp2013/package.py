...
class RDonapllp2013(RPackage):
	...
	bioc = "DonaPLLP2013" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/DonaPLLP2013_1.40.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/DonaPLLP2013/DonaPLLP2013_1.40.0.tar.gz"]

	version("1.40.0", md5="d8dc37afefc52856d520540b07faf545", url="https://www.bioconductor.org/packages/release/data/experiment/src/contrib/DonaPLLP2013_1.40.0.tar.gz")

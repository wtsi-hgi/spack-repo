...
class RBionar(RPackage):
	...
	bioc = "BioNAR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/BioNAR_1.4.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/BioNAR/BioNAR_1.4.1.tar.gz"]

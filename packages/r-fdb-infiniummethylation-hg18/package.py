...
class RFdbInfiniummethylationHg18(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/FDb.InfiniumMethylation.hg18_2.2.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/FDb.InfiniumMethylation.hg18/FDb.InfiniumMethylation.hg18_2.2.0.tar.gz"]

...
class PyNumba(PythonPackage):
    ...
    depends_on("py-numpy@1.22:2.5", when="@0.64:0.66", type=("build", "run"))
    depends_on("py-numpy@1.22:2.4", when="@0.63:0.64", type=("build", "run"))
    depends_on("py-numpy@1.22:2.3", when="@0.62:0.63", type=("build", "run"))
    depends_on("py-numpy@1.24:2.2", when="@0.61.1:0.64", type=("build", "run"))

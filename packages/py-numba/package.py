...
class PyNumba(PythonPackage):
    ...
    depends_on("python@3.8.0:", when="@0.58.0:", type=("build", "run"))
    depends_on("python@3.7:3.10", when="@0.55.0:0.56.4", type=("build", "run"))
    ...
    depends_on("py-numpy@1.18:1.23", when="@0.58.0", type=("build", "run"))

...
class PyNumba(PythonPackage):
    ...
    version("0.59.0", sha256="12b9b064a3e4ad00e2371fc5212ef0396c80f41caec9b5ec391c8b04b6eaf2a8")
    ...
    depends_on("python@3.10:3.15", when="@0.63:", type=("build", "run"))
    depends_on("python@3.10:3.14", when="@0.61:0.63", type=("build", "run"))
    depends_on("python@3.9:3.13", when="@0.60:0.61", type=("build", "run"))
    depends_on("python@3.9:3.13", when="@0.59:0.60", type=("build", "run"))
    ...
    depends_on("python@3.6:3.8", when="@0.48:0.52", type=("build", "run"))
    depends_on("py-numpy@1.22:2.5", when="@0.65:", type=("build", "run"))
    depends_on("py-numpy@1.22:2.4", when="@0.64", type=("build", "run"))
    depends_on("py-numpy@1.22:2.3", when="@0.62:0.63", type=("build", "run"))
    depends_on("py-numpy@1.24:2.2", when="@0.61.1:0.61", type=("build", "run"))
    depends_on("py-numpy@1.24:2.1", when="@0.61.0", type=("build", "run"))
    depends_on("py-numpy@1.22:2.0", when="@0.60", type=("build", "run"))
    ...
    depends_on("py-llvmlite@0.46", when="@0.63:0.64", type=("build", "run"))
    ...
    depends_on("py-llvmlite@0.43", when="@0.59", type=("build", "run"))

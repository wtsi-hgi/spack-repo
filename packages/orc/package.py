...
class Orc(CMakePackage):
    ...
    version(
        "2.0.1",
        sha256="3a57c1e13ffc490651270e143a85050e26204faa38ff6c412c94a74098ef8d98",
    )
    version(
        "2.0.0",
        sha256="19bc533074867b3bbc3c8c1a1bf489ba738e8fd257fa65990159c68736dae4a8",
    )
    version(
        "1.9.3",
    ...
    version(
        "1.9.2",
        sha256="cb933316cd40d611bcd1a2ccc6805455efcf88b8027ada6b3888666d4afee63a",
    )
    version(
        "1.9.1",
        sha256="7f8bbc862521ae99889205fb788e4906ecaaa6e503f075f6d3b78eeda8649322",
    )
    version(
        "1.9.0",
        sha256="951b09fdcded6518a05674a238824eaf81ad5e971e1adbb231bea7333215a75e",
    )
    version(
        "1.8.7",
        sha256="3f622918dac0f0b5531de3f28995cbab4067736390f9b6cfd8edc168b84797e8",
    )
    version(
        "1.8.6",
        sha256="83f0b0ef62a22a0f6dcbfb7c3a3bd3ebfd5d0deb07445fe7a498d6cd37eedda6",
    )
    version(
        "1.8.5",
        sha256="196d5d26e8a8490e397c5fe2bc01f3117c9fa44b6e53be4775b4261a8b10b1ad",
    )
    version(
        "1.7.10",
        sha256="9e8c69c038b144ea5927ea7251947e1a4cf1e745a003b61eb8a2cdf8d0dbaaa0",
    )
    version(
        "1.6.5",
    ...
    depends_on("maven")
    depends_on("openssl")
    depends_on("openjdk@17:", type=("build", "run"), when="@2.0.0:")
    depends_on("openjdk@1.8:", type=("build", "run"), when="@1.6.5:1.9.3")
    depends_on("zlib-api")

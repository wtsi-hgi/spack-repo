...
class RGsva(RPackage):
	...
	bioc = "GSVA" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/GSVA_1.50.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/GSVA/GSVA_1.50.0.tar.gz"]

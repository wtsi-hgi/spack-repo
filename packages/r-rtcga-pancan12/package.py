...
class RRtcgaPancan12(RPackage):
	...
	bioc = "RTCGA.PANCAN12" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/RTCGA.PANCAN12_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/RTCGA.PANCAN12/RTCGA.PANCAN12_1.30.0.tar.gz"]

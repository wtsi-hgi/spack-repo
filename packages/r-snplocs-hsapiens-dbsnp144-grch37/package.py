...
class RSnplocsHsapiensDbsnp144Grch37(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/SNPlocs.Hsapiens.dbSNP144.GRCh37_0.99.20.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/SNPlocs.Hsapiens.dbSNP144.GRCh37/SNPlocs.Hsapiens.dbSNP144.GRCh37_0.99.20.tar.gz"]

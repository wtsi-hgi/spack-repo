...
class RBsgenomeGgallusUcscGalgal4Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Ggallus.UCSC.galGal4.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Ggallus.UCSC.galGal4.masked/BSgenome.Ggallus.UCSC.galGal4.masked_1.3.99.tar.gz",
    ]

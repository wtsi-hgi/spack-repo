...
class RAlphamissenseV2023Hg38(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/AlphaMissense.v2023.hg38_3.18.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/AlphaMissense.v2023.hg38/AlphaMissense.v2023.hg38_3.18.2.tar.gz"]

...
class PyMlDtypes(PythonPackage):
    ...
    version("0.5.4", tag="v0.5.4", commit="9fd1a480f1cdb23b3d28dfea5eadf3d84b6dfc62")
    ...
    depends_on("py-setuptools@80.9:", when="@0.5.4:", type="build")
    depends_on("py-setuptools", when="@:0.4", type="build")

    def patch(self):
        if self.spec.satisfies("@0.5.4:"):
            filter_file(

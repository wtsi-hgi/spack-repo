...
class RMait(RPackage):
	...
	bioc = "MAIT" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MAIT_1.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MAIT/MAIT_1.36.0.tar.gz"]

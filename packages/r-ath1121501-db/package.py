...
class RAth1121501Db(RPackage):
	...
	bioc = "ath1121501.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/ath1121501.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/ath1121501.db/ath1121501.db_3.13.0.tar.gz"]

...
class RLumihumanidmapping(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/lumiHumanIDMapping_1.10.1.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/lumiHumanIDMapping/lumiHumanIDMapping_1.10.1.tar.gz",
    ]

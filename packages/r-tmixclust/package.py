...
class RTmixclust(RPackage):
	...
	bioc = "TMixClust"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/TMixClust_1.24.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/TMixClust/TMixClust_1.24.0.tar.gz"]

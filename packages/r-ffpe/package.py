...
class RFfpe(RPackage):
	...
	bioc = "ffpe" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ffpe_1.46.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ffpe/ffpe_1.46.0.tar.gz"]

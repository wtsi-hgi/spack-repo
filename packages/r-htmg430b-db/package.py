...
class RHtmg430bDb(RPackage):
	...
	bioc = "htmg430b.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/htmg430b.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/htmg430b.db/htmg430b.db_3.13.0.tar.gz"]

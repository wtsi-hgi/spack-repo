...
class RGoseq(RPackage):
	...
	bioc = "goseq"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/goseq_1.54.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/goseq/goseq_1.54.0.tar.gz"]

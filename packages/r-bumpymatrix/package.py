...
class RBumpymatrix(RPackage):
	...
	bioc = "BumpyMatrix" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/BumpyMatrix_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/BumpyMatrix/BumpyMatrix_1.10.0.tar.gz"]

...
class RHypergraph(RPackage):
	...
	bioc = "hypergraph"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/hypergraph_1.74.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/hypergraph/hypergraph_1.74.0.tar.gz"]

...
class RMirbaseversionsDb(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/miRBaseVersions.db_1.1.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/miRBaseVersions.db/miRBaseVersions.db_1.1.0.tar.gz",
    ]

...
class RGenetclassifier(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/geNetClassifier_1.42.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/geNetClassifier/geNetClassifier_1.42.0.tar.gz"]

...
class RZlibbioc(RPackage):
	...
	bioc = "zlibbioc"
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/zlibbioc_1.48.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/zlibbioc/zlibbioc_1.48.0.tar.gz"]

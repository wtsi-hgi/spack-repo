...
class RBsgenomeMfascicularisNcbi50(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Mfascicularis.NCBI.5.0_1.4.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Mfascicularis.NCBI.5.0/BSgenome.Mfascicularis.NCBI.5.0_1.4.2.tar.gz"]

...
class RTidymodels(RPackage):
	...
	depends_on("r-dials@1.2.1:", type=("build", "run"))
	depends_on("r-dplyr@1.1.4:", type=("build", "run"))
	depends_on("r-ggplot2@3.5:", type=("build", "run"))
	depends_on("r-hardhat@1.3.1:", type=("build", "run"))
	depends_on("r-infer@1.0.6:", type=("build", "run"))
	depends_on("r-modeldata@1.3:", type=("build", "run"))
	depends_on("r-parsnip@1.2.1:", type=("build", "run"))
	depends_on("r-purrr@1.0.2:", type=("build", "run"))
	depends_on("r-recipes@1.0.10:", type=("build", "run"))
	depends_on("r-rlang@1.1.3:", type=("build", "run"))
	depends_on("r-rsample@1.2.1:", type=("build", "run"))
	depends_on("r-rstudioapi@0.16:", type=("build", "run"))
	...
	depends_on("r-workflowsets@1.1:", type=("build", "run"))
	depends_on("r-yardstick@1.3.1:", type=("build", "run"))

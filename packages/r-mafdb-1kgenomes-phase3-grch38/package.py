...
class RMafdb1kgenomesPhase3Grch38(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/MafDb.1Kgenomes.phase3.GRCh38_3.10.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/MafDb.1Kgenomes.phase3.GRCh38/MafDb.1Kgenomes.phase3.GRCh38_3.10.0.tar.gz"]

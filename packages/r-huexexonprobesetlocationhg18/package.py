...
class RHuexexonprobesetlocationhg18(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/HuExExonProbesetLocationHg18_0.0.2.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/HuExExonProbesetLocationHg18/HuExExonProbesetLocationHg18_0.0.2.tar.gz",
    ]

    version(
        "0.0.2",
        sha256="2fc903d7d581fa806b99eeebbaad6f6ddbf2ec3c8f8856c47ed9980016ab8b92",
        url="https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/HuExExonProbesetLocationHg18_0.0.2.tar.gz",
    )

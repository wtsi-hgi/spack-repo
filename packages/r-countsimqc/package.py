...
class RCountsimqc(RPackage):
	...
	bioc = "countsimQC" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/countsimQC_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/countsimQC/countsimQC_1.20.0.tar.gz"]

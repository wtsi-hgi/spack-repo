...
class RBladderbatch(RPackage):
	...
	bioc = "bladderbatch" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/bladderbatch_1.40.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/bladderbatch/bladderbatch_1.40.0.tar.gz"]

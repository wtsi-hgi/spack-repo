...
class RBsgenomeHsapiensUcscHg38Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Hsapiens.UCSC.hg38.masked_1.4.5.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Hsapiens.UCSC.hg38.masked/BSgenome.Hsapiens.UCSC.hg38.masked_1.4.5.tar.gz",
    ]

    version(
        "1.4.5",
        sha256="1588b6a5363593f5bf2f497e854b022e5701cafce64ac32ad280ed8d7b83e148",
    )

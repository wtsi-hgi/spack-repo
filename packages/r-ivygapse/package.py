...
class RIvygapse(RPackage):
	...
	bioc = "ivygapSE" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ivygapSE_1.24.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ivygapSE/ivygapSE_1.24.0.tar.gz"]

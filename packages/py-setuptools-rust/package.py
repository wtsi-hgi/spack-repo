...
class PySetuptoolsRust(PythonPackage):
    ...
    # setuptools-rust <=1.6.0 imports pkg_resources which was removed in setuptools 71
    depends_on("py-setuptools@62.4:70", when="@1.4.0:1.6", type=("build", "run"))
    depends_on("py-setuptools@:70", when="@:1.3", type=("build", "run"))
    depends_on("py-setuptools@62.4:", when="@1.7:", type=("build", "run"))

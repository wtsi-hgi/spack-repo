...
class RIseq(RPackage):
	...
	bioc = "iSeq" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/iSeq_1.54.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/iSeq/iSeq_1.54.0.tar.gz"]

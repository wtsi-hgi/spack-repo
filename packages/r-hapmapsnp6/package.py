...
class RHapmapsnp6(RPackage):
	...
	bioc = "hapmapsnp6" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/hapmapsnp6_1.44.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/hapmapsnp6/hapmapsnp6_1.44.0.tar.gz"]

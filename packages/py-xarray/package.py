...
class PyXarray(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("python@3.10:", when="@2024.10:")
        ...
        depends_on("py-pandas@:1", when="@:2022.3.0")
        ...
        depends_on("py-netcdf4", when="+io")
        depends_on("py-netcdf4@1.6:", when="@2025.7: +io")
        depends_on("py-h5netcdf", when="+io")
        depends_on("py-h5netcdf@1.5:+h5py", when="@2026.4: +io")
        depends_on("py-h5netcdf@1.4:", when="@2026: +io")
        depends_on("py-scipy", when="+io")
        depends_on("py-scipy@1.15:", when="@2026.4: +io")
        depends_on("py-scipy@1.13:", when="@2025.7: +io")
        depends_on("py-pydap", when="+io ^python@:3.9")
        depends_on("py-zarr", when="+io")
        depends_on("py-zarr@3:", when="@2026.4: +io")
        depends_on("py-zarr@2.18:", when="@2025.7: +io")
        
        depends_on("py-fsspec", when="+io")
        depends_on("py-cftime", when="+io")
        depends_on("py-rasterio", when="@:2022.3.0 +io")
        depends_on("py-cfgrib", when="@:2022.3.0 +io")
        depends_on("py-pooch", when="+io")

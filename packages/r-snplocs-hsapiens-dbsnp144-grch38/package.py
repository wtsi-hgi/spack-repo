...
class RSnplocsHsapiensDbsnp144Grch38(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/SNPlocs.Hsapiens.dbSNP144.GRCh38_0.99.20.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/SNPlocs.Hsapiens.dbSNP144.GRCh38/SNPlocs.Hsapiens.dbSNP144.GRCh38_0.99.20.tar.gz"]

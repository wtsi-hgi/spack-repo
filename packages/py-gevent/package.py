...
class PyGevent(PythonPackage):
    ...
    depends_on("py-setuptools@40.8:69", when="@20.5.1:", type="build")
    depends_on("py-setuptools@40.8:69", when="@1.5:", type="build")
    depends_on("py-setuptools@24.2:69", when="@:1.4", type="build")

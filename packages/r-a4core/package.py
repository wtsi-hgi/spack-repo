...
class RA4core(RPackage):
	...
	bioc = "a4Core"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/a4Core_1.50.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/a4Core/a4Core_1.50.0.tar.gz"]

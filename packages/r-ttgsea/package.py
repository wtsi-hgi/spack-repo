...
class RTtgsea(RPackage):
	...
	bioc = "ttgsea" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ttgsea_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ttgsea/ttgsea_1.10.0.tar.gz"]

	version("1.10.0", md5="0b38c9baea88905217b9ed667c80c26f")

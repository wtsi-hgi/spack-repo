...
class RCaddV16Hg19(RPackage):
	...
	bioc = "cadd.v1.6.hg19" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/cadd.v1.6.hg19_3.18.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/cadd.v1.6.hg19/cadd.v1.6.hg19_3.18.1.tar.gz"]

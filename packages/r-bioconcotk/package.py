...
class RBioconcotk(RPackage):
	...
	bioc = "BiocOncoTK" 
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/BiocOncoTK_1.22.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/BiocOncoTK/BiocOncoTK_1.22.0.tar.gz"]

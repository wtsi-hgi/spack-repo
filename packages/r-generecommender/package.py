...
class RGenerecommender(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/geneRecommender_1.74.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/geneRecommender/geneRecommender_1.74.0.tar.gz"]

	version("1.74.0", md5="cd697c11912a8f48b5ceaf0abfbb206e")

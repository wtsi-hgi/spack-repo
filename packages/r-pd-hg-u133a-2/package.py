...
class RPdHgU133a2(RPackage):
	...
	version("3.12.0", md5="a7941473bf081831fad4f4412023d9ee", url="https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/pd.hg.u133a.2_3.12.0.tar.gz")

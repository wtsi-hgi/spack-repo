...
class PySetuptoolsScmGitArchive(PythonPackage):
    ...
    version("1.4.0", sha256="b048b27b32e1e76ec865b0caa4bb85df6ddbf4697d6909f567ac36709f6ef2f0")
    ...
    depends_on("py-pip@:23.0", type="build", when="@1.0")

    @run_after("install")
    def install_test(self):
        with working_dir("spack-test", create=True):
            python("-c", "import setuptools_scm_git_archive")

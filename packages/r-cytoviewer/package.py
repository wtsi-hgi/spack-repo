...
class RCytoviewer(RPackage):
	...
	bioc = "cytoviewer" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/cytoviewer_1.2.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/cytoviewer/cytoviewer_1.2.0.tar.gz"]

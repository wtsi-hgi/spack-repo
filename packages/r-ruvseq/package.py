...
class RRuvseq(RPackage):
	...
	bioc = "RUVSeq" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/RUVSeq_1.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/RUVSeq/RUVSeq_1.36.0.tar.gz"]

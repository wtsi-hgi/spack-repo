...
class RGenomeinfodb(RPackage):
	...
	depends_on("r-ucsc-utils@:1.5", type=("build", "run"), when="@:1.45")
	depends_on("r-iranges@2.41.1:", type=("build", "run"), when="@1.44.0:")
	depends_on("r-seqinfo@0.99.2:", type=("build", "run"), when="@1.46.0:")
	depends_on("r-ucsc-utils@1.6.0", type=("build", "run"), when="@1.46.0:")
	depends_on("r-iranges@2.41.1:", type=("build", "run"), when="@1.46.0:")
	depends_on("r-s4vectors@0.47.6:", type=("build", "run"), when="@1.46.0:")
	depends_on("r-biocgenerics@0.53.2:", type=("build", "run"), when="@1.46.0:")

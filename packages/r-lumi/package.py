...
class RLumi(RPackage):
	...
	bioc = "lumi"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/lumi_2.54.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/lumi/lumi_2.54.0.tar.gz"]

...
class Pangomm(MesonPackage):
    ...
    version("2.50.2", sha256="1bc5ab4ea3280442580d68318226dab36ceedfc3288f9d83711cf7cfab50a9fb")
    version("2.46.4", sha256="b92016661526424de4b9377f1512f59781f41fb16c9c0267d6133ba1cd68db22")
    ...
    depends_on("pango")
    depends_on("glibmm@:2.66", when="@:2.46")
    depends_on("glibmm@2.68:", when="@2.48:")
    depends_on("cairomm@1.16:", when="@2.48:")
    depends_on("cairomm@:1.14", when="@:2.46")

...
class RMbpcr(RPackage):
	...
	bioc = "mBPCR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/mBPCR_1.56.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/mBPCR/mBPCR_1.56.0.tar.gz"]

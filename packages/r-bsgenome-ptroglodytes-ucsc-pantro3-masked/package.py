...
class RBsgenomePtroglodytesUcscPantro3Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Ptroglodytes.UCSC.panTro3.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Ptroglodytes.UCSC.panTro3.masked/BSgenome.Ptroglodytes.UCSC.panTro3.masked_1.3.99.tar.gz",
    ]

...
class RHelp(RPackage):
	...
	bioc = "HELP" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HELP_1.60.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HELP/HELP_1.60.0.tar.gz"]

...
class RBiocneighbors(RPackage):
    ...
    version("2.4.0", sha256="7367c7f5ca7c58a3f5b610b3babae2c31f3f310cfde349067da48897494fa0fb", url="https://www.bioconductor.org/packages/3.22/bioc/src/contrib/BiocNeighbors_2.4.0.tar.gz")
    version("2.2.0", sha256="3c5a6b91c7318702e51d3defc47591eee0a3f6babfc4c91a4b28f953e0a2d605", url="https://www.bioconductor.org/packages/3.21/bioc/src/contrib/BiocNeighbors_2.2.0.tar.gz")
    version("1.20.2", md5="60f1ea60fb00cfd92dfa247765da9204", url="https://www.bioconductor.org/packages/3.18/bioc/src/contrib/BiocNeighbors_1.20.2.tar.gz")

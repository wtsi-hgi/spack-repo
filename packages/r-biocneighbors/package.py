...
class RBiocneighbors(RPackage):
    ...
    version("2.2.0", tag="RELEASE_3_21", url=["https://www.bioconductor.org/packages/3.21/bioc/src/contrib/BiocNeighbors_2.2.0.tar.gz", "https://www.bioconductor.org/packages/3.21/bioc/src/contrib/Archive/BiocNeighbors/BiocNeighbors_2.2.0.tar.gz"])

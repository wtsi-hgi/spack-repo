...
class RBeta7(RPackage):
	...
	bioc = "beta7" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/beta7_1.40.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/beta7/beta7_1.40.0.tar.gz"]

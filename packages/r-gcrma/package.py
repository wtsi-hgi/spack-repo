...
class RGcrma(RPackage):
	...
	bioc = "gcrma"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/gcrma_2.74.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/gcrma/gcrma_2.74.0.tar.gz"]

...
class RGviz(RPackage):
	...
	bioc = "Gviz"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Gviz_1.46.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Gviz/Gviz_1.46.1.tar.gz"]

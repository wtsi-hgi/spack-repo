...
class RBsgenomeVviniferaUrgiIggp8x(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Vvinifera.URGI.IGGP8X_0.1.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Vvinifera.URGI.IGGP8X/BSgenome.Vvinifera.URGI.IGGP8X_0.1.tar.gz",
    ]

    version(
        "0.1", sha256="2d82778b3ef0a5797683c27cbf2722fbad93ff227bed2552b3bec4b5ae88106c"
    )

...
class RHmdbquery(RPackage):
	...
	bioc = "hmdbQuery" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/hmdbQuery_1.22.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/hmdbQuery/hmdbQuery_1.22.0.tar.gz"]

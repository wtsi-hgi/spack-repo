...
class RScp(RPackage):
    ...
    bioc = "scp"
    urls = [
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/scp_1.12.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/scp/scp_1.12.0.tar.gz",
    ]

...
class RBsgenomeMmulattaUcscRhemac3Masked(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Mmulatta.UCSC.rheMac3.masked_1.3.99.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Mmulatta.UCSC.rheMac3.masked/BSgenome.Mmulatta.UCSC.rheMac3.masked_1.3.99.tar.gz"]

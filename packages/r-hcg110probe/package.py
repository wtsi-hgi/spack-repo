...
class RHcg110probe(RPackage):
	...
	bioc = "hcg110probe" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/hcg110probe_2.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/hcg110probe/hcg110probe_2.18.0.tar.gz"]

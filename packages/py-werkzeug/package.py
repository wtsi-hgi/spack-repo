...
class PyWerkzeug(PythonPackage):
    ...
    pypi = "werkzeug/werkzeug-3.1.5.tar.gz"
    ...
    depends_on("py-flit-core@3.12:", when="@3.1:", type="build")
    depends_on("py-flit-core@:3", when="@2.3.7:3.0", type="build")
    ...
    def install_test(self):
        with working_dir("spack-test", create=True):
            ...
            python("-c", "import werkzeug; from werkzeug.wrappers import Response; Response('ok')")

...
class RRsamtools(RPackage):
	...
	version("2.24.1", md5="0ed68b3325ece17f53f9362b50a5e172", url="https://bioconductor.org/packages/3.21/bioc/src/contrib/Rsamtools_2.24.1.tar.gz")
	...
	depends_on("r-genomeinfodb@:1.45", type=("build", "run"), when="@:2.25")
	...
	depends_on("r-rhtslib@1.99.3:3.3.0", type=("build", "run"), when="@:2.23")
	depends_on("lzma", type=("build", "link", "run"))
	depends_on("bzip2", type=("build", "link", "run"))
	depends_on("xz", type=("build", "link", "run"))
	depends_on("zlib", type=("build", "link", "run"))
	depends_on("curl", type=("build", "link", "run"))
	depends_on("r-biostrings@2.47.6:", type=("build", "run"), when="@2.18.0:")
	depends_on("r-s4vectors@0.17.25:", type=("build", "run"), when="@2.18.0:")
	depends_on("r-iranges@2.13.12:", type=("build", "run"), when="@2.18.0:")
	depends_on("r-xvector@0.19.7:", type=("build", "run"), when="@2.18.0:")

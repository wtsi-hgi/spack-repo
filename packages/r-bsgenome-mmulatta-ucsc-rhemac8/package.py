...
class RBsgenomeMmulattaUcscRhemac8(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Mmulatta.UCSC.rheMac8_1.4.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Mmulatta.UCSC.rheMac8/BSgenome.Mmulatta.UCSC.rheMac8_1.4.2.tar.gz"]

...
class RIlluminaio(RPackage):
	...
	bioc = "illuminaio"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/illuminaio_0.44.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/illuminaio/illuminaio_0.44.0.tar.gz"]

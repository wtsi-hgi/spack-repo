...
class RKaryoploter(RPackage):
	...
	bioc = "karyoploteR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/karyoploteR_1.28.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/karyoploteR/karyoploteR_1.28.0.tar.gz"]

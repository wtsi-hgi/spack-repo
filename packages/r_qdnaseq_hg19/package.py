...
class RQdnaseqHg19(RPackage):
	...
	version("1.32.0", md5="2b663d8771f16d55db88ec3321942ead", url="https://www.bioconductor.org/packages/3.18/data/experiment/src/contrib/QDNAseq.hg19_1.32.0.tar.gz")

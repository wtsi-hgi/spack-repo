...
class Bcftools(AutotoolsPackage):
    ...
    git = "https://github.com/samtools/bcftools.git"

    license("GPL-3.0-or-later")

    version("1.22.1", tag="1.22.1")
    version("1.22.0", sha256="f2ab9e2f605b1203a7e9cbfb0a3eb7689322297f8c34b45dc5237fe57d98489f")
    ...
    depends_on("autoconf", type="build", when="@1.22.1 build_system=autotools")
    depends_on("automake", type="build", when="@1.22.1 build_system=autotools")
    depends_on("libtool", type="build", when="@1.22.1 build_system=autotools")

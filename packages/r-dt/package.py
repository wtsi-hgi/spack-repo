...
class RDt(RPackage):
    ...
    cran = "DT"
    version("0.34.0", sha256="8862025ef26af65b53f072adb1d133c25c5f96a812e7ae0aa822baa71249f1f2")
    ...
    with default_args(type=("build", "run")):
        with when("@0.1:"):
            depends_on("r-htmltools@0.3.6:")
            depends_on("r-htmlwidgets@1.3:")
            depends_on("r-magrittr")

        with when("@0.2:"):
            depends_on("r-crosstalk")
        
        with when("@0.4:"):
            depends_on("r-promises")
        
        with when("@0.7:"):
            depends_on("r-jsonlite@0.9.16:")

        with when("@0.18.2:"):
            depends_on("r-jquerylib")

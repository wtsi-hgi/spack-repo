...
class RSnphooddata(RPackage):
	...
	bioc = "SNPhoodData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/SNPhoodData_1.32.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/SNPhoodData/SNPhoodData_1.32.0.tar.gz"]

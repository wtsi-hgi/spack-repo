...
class RBarcodetrackr(RPackage):
	...
	bioc = "barcodetrackR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/barcodetrackR_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/barcodetrackR/barcodetrackR_1.10.0.tar.gz"]

...
class RMsstats(RPackage):
	...
	bioc = "MSstats" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MSstats_4.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MSstats/MSstats_4.10.0.tar.gz"]

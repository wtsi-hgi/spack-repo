...
class REpistack(RPackage):
	...
	bioc = "epistack" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/epistack_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/epistack/epistack_1.8.0.tar.gz"]

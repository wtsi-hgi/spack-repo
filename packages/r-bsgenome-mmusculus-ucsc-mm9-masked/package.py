...
class RBsgenomeMmusculusUcscMm9Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Mmusculus.UCSC.mm9.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Mmusculus.UCSC.mm9.masked/BSgenome.Mmusculus.UCSC.mm9.masked_1.3.99.tar.gz",
    ]

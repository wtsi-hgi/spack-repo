...
class RBsgenomeGaculeatusUcscGasacu1(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Gaculeatus.UCSC.gasAcu1_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Gaculeatus.UCSC.gasAcu1/BSgenome.Gaculeatus.UCSC.gasAcu1_1.4.0.tar.gz"]

...
class RBsgenomeCreinhardtiiJgiV56(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Creinhardtii.JGI.v5.6_1.5.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Creinhardtii.JGI.v5.6/BSgenome.Creinhardtii.JGI.v5.6_1.5.0.tar.gz"]

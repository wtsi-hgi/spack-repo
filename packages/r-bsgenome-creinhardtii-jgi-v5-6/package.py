...
class RBsgenomeCreinhardtiiJgiV56(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Creinhardtii.JGI.v5.6_1.5.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Creinhardtii.JGI.v5.6/BSgenome.Creinhardtii.JGI.v5.6_1.5.0.tar.gz",
    ]

    version(
        "1.5.0",
        md5="2bd1be53d19249ac14ad7f39dc00af0e",
        url="https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Creinhardtii.JGI.v5.6_1.5.0.tar.gz",
    )

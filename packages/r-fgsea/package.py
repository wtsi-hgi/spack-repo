...
class RFgsea(RPackage):
	...
	bioc = "fgsea"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/fgsea_1.28.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/fgsea/fgsea_1.28.0.tar.gz"]

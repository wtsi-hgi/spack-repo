...
class RPdHta20(RPackage):
	...
	bioc = "pd.hta.2.0" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/pd.hta.2.0_3.12.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/pd.hta.2.0/pd.hta.2.0_3.12.2.tar.gz"]

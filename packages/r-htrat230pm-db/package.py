...
class RHtrat230pmDb(RPackage):
	...
	bioc = "htrat230pm.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/htrat230pm.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/htrat230pm.db/htrat230pm.db_3.13.0.tar.gz"]

...
class RVariantfiltering(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/VariantFiltering_1.38.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/VariantFiltering/VariantFiltering_1.38.0.tar.gz"]

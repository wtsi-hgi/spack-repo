...
class RTrajectorygeometry(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/TrajectoryGeometry_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/TrajectoryGeometry/TrajectoryGeometry_1.10.0.tar.gz"]

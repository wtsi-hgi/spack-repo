...
class RVitisviniferaprobe(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/vitisviniferaprobe_2.18.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/vitisviniferaprobe/vitisviniferaprobe_2.18.0.tar.gz",
    ]

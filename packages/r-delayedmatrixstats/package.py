...
class RDelayedmatrixstats(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/DelayedMatrixStats_1.24.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/DelayedMatrixStats/DelayedMatrixStats_1.24.0.tar.gz",
    ]
    ...
    depends_on("r-matrixgenerics@1.15.1:", type=("build", "run"), when="@1.30.0:")
    depends_on("r-delayedarray@0.31.7:", type=("build", "run"), when="@1.30.0:")
    ...
    depends_on("r-sparsearray@1.5.19:", type=("build", "run"), when="@1.30.0:")

...
class RTcgabiolinksguiData(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/TCGAbiolinksGUI.data_1.22.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/TCGAbiolinksGUI.data/TCGAbiolinksGUI.data_1.22.0.tar.gz"]

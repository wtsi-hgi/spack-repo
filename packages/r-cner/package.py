...
class RCner(RPackage):
	...
	bioc = "CNEr"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/CNEr_1.38.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/CNEr/CNEr_1.38.0.tar.gz"]

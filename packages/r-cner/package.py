...
class RCner(RPackage):
	...
	version("1.42.0", tag="RELEASE_3_20")
	version("1.40.0", tag="RELEASE_3_19")
	version("1.38.0", tag="RELEASE_3_18")
	...
	depends_on("r-genomeinfodb@1.1.3:1.45", type=("build", "run"), when="@:1.44")
	depends_on("r-genomeinfodb@1.1.3:", type=("build", "run"), when="@1.45:")
	...
	depends_on("r-seqinfo@0.99.2:", when="@1.45.2:")

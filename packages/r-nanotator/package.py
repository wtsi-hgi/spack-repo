...
class RNanotator(RPackage):
	...
	bioc = "nanotatoR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/nanotatoR_1.18.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/nanotatoR/nanotatoR_1.18.0.tar.gz"]
	...
	depends_on("r-varfrompdb", type=("build", "run"))

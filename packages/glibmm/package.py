...
class Glibmm(AutotoolsPackage, MesonPackage):
    """Glibmm is a C++ wrapper for the glib library."""

    homepage = "https://gitlab.gnome.org/GNOME/glibmm"
    url = "https://download-fallback.gnome.org/sources/glibmm/2.66/glibmm-2.66.7.tar.xz"

    license("LGPL-2.1-or-later")

    version("2.70.0", sha256="8008fd8aeddcc867a3f97f113de625f6e96ef98cf7860379813a9c0feffdb520")
    version("2.66.7", sha256="fe02c1e5f5825940d82b56b6ec31a12c06c05c1583cfe62f934d0763e1e542b3")
    ...
    depends_on("libsigcpp@:2.9", when="@:2.66")
    depends_on("glib")
    depends_on("pkgconfig", type="build")

    patch("guint16_cast.patch", when="@2.19.3")
    build_system(conditional("meson", when="@2.66:"), conditional("autotools", when="@:2.19"), default="autotools")

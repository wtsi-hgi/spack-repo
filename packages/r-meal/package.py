...
class RMeal(RPackage):
	...
	bioc = "MEAL" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MEAL_1.32.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MEAL/MEAL_1.32.0.tar.gz"]

...
class RPepxmltab(RPackage):
	...
	bioc = "pepXMLTab" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/pepXMLTab_1.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/pepXMLTab/pepXMLTab_1.36.0.tar.gz"]

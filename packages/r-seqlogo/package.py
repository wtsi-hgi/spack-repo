...
class RSeqlogo(RPackage):
    ...
    bioc = "seqLogo"
    urls = [
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/seqLogo_1.68.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/seqLogo/seqLogo_1.68.0.tar.gz",
    ]
    ...
    # Allow building with R 4.1.x to match environments pinning r@4.1.3
    depends_on("r@4.1:", type=("build", "run"), when="@1.62:")

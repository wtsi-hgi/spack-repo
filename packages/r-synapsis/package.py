...
class RSynapsis(RPackage):
	...
	bioc = "synapsis" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/synapsis_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/synapsis/synapsis_1.8.0.tar.gz"]

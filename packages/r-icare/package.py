...
class RIcare(RPackage):
	...
	bioc = "iCARE" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/iCARE_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/iCARE/iCARE_1.30.0.tar.gz"]

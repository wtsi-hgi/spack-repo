...
class PyPytest(PythonPackage):
    ...
    pypi = "pytest/pytest-9.0.2.tar.gz"
    ...
    version("9.0.1", sha256="3e9c069ea73583e255c3b21cf46b8d3c56f6e3a1a8f6da94ccb0fcf57b9d73c8")
    ...
    depends_on("py-setuptools@77:", when="@9:", type="build")
    depends_on("py-setuptools@61:", when="@8.1:", type="build")
    depends_on("py-setuptools@45:", when="@7:", type="build")
    depends_on("py-setuptools@42:", when="@6.2:", type="build")
    depends_on("py-setuptools@40:", when="@3.9.2:", type="build")
    depends_on("py-setuptools@30.3:", when="@3.9.0:", type="build")
    ...
    depends_on("python@3.9:", when="@8.4:", type=("build", "run"))
    depends_on("python@3.8:", when="@8:", type=("build", "run"))
    depends_on("python@3.7:", when="@7.1:", type=("build", "run"))
    depends_on("python@:3.13", when="@:8.3", type=("build", "run"))
    depends_on("python@:3.12", when="@:8.2.0", type=("build", "run"))
    depends_on("python@:3.11", when="@:7.3.1", type=("build", "run"))
    depends_on("py-colorama@0.4:", when="@8.4: platform=windows", type=("build", "run"))
    depends_on("py-colorama", when="platform=windows", type=("build", "run"))
    depends_on("py-exceptiongroup@1:", when="@7:^python@:3.10", type=("build", "run"))
    depends_on("py-iniconfig@1.0.1:", when="@9:", type=("build", "run"))
    depends_on("py-iniconfig@1:", when="@8.4:", type=("build", "run"))
    depends_on("py-iniconfig", when="@6.0:", type=("build", "run"))
    depends_on("py-typing-extensions@4.6:", when="@9:", type=("build", "run"))
    depends_on("py-packaging@24.2:", when="@9:", type=("build", "run"))
    depends_on("py-packaging@20:", when="@8.4:", type=("build", "run"))
    depends_on("py-packaging", when="@4.6:", type=("build", "run"))
    depends_on("py-pluggy@1.5:1", when="@8.2:", type=("build", "run"))
    depends_on("py-pluggy@1.3:1", when="@8.0:8.1", type=("build", "run"))
    ...
    depends_on("py-pygments@2.7.2:", when="@8.4:", type=("build", "run"))
    ...
    def install_test(self):
        pytest = Executable(join_path(self.prefix.bin, "pytest"))
        pytest("--version")

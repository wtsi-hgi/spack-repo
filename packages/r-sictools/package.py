...
class RSictools(RPackage):
	...
	bioc = "SICtools" 
	urls = ["https://www.bioconductor.org/packages/3.18/bioc/src/contrib/SICtools_1.32.0.tar.gz", "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/Archive/SICtools/SICtools_1.32.0.tar.gz"]

...
class REnsdbMmusculusV79(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/EnsDb.Mmusculus.v79_2.99.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/EnsDb.Mmusculus.v79/EnsDb.Mmusculus.v79_2.99.0.tar.gz"]

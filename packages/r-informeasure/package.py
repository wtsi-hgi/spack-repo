...
class RInformeasure(RPackage):
	...
	bioc = "Informeasure" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Informeasure_1.12.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Informeasure/Informeasure_1.12.1.tar.gz"]

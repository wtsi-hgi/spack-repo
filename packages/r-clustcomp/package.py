...
class RClustcomp(RPackage):
	...
	bioc = "clustComp" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/clustComp_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/clustComp/clustComp_1.30.0.tar.gz"]

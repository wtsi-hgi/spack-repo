...
class RBlma(RPackage):
	...
	bioc = "BLMA" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/BLMA_1.26.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/BLMA/BLMA_1.26.0.tar.gz"]

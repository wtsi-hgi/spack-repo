...
class RPhastcons100wayUcscHg38(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/phastCons100way.UCSC.hg38_3.7.1.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/phastCons100way.UCSC.hg38/phastCons100way.UCSC.hg38_3.7.1.tar.gz"]

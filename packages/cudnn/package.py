...
_versions = {
    ...
    "8.4.0.27-10.2": {"Linux-x86_64": "14c5e3ca4258271996d1fd959c42d17c582ce4d9aff451f84524469e784fd154"},
    # cuDNN 8.3.3
    "8.3.3.40-11.5": {
    ...
    "8.3.3.40-10.2": {"Linux-x86_64": "d8554f2b32e6295d5fc8f3ac25e68f94058b018c801dab9c143e36812f8926ab"},
    # cuDNN 8.3.2
    "8.3.2.44-11.5": {
    ...
    "8.2.0.53-10.2": {"Linux-x86_64": "6ecbc98b3795e940ce0831ffb7cd2c0781830fdd6b1911f950bcaf6d569f807c"},
    # cuDNN 8.1.1
    "8.1.1.33-11.2": {
    ...
    "8.1.1.33-10.2": {"Linux-x86_64": "2a4a7b99a6e9bfa690eb19bb41e49553f2a7a491a5b3abfcae900e166c5b6ebd"},
    # cuDNN 8.1.0
    "8.1.0.77-11.2": {
    ...
    "7.6.5.32-9.0": {"Linux-x86_64": "bd0a4c0090d5b02feec3f195738968690cc2470b9bc6026e6fe8ff245cd261c8"},
    # cuDNN 7.6.4
    "7.6.4.38-10.1": {
    ...
    # cuDNN 7.3.0
    "7.3.0.29-9.0": {"Linux-x86_64": "403f9043ff2c7b2c5967454872275d07bca11fd41dfc7b21995eadcad6dbe49b"},
    # cuDNN 7.2.1
    "7.2.1.38-9.0": {"Linux-x86_64": "cf007437b9ac6250ec63b89c25f248d2597fdd01369c80146567f78e75ce4e37"},
    # cuDNN 7.1.3
    "7.1.3-9.1": {
    ...
    # cuDNN 6.0
    "6.0-8.0": {"Linux-x86_64": "9b09110af48c9a4d7b6344eb4b3e344daa84987ed6177d5c44319732f3bb7f9c"},
    # cuDNN 5.1
    "5.1-8.0": {"Linux-x86_64": "c10719b36f2dd6e9ddc63e3189affaa1a94d7d027e63b71c3f64d449ab0645ce"},
}
...
class Cudnn(Package):
    ...
    def url_for_version(self, version):
        ...
        if version < Version("8.3.1"):
            sys_key = sys_key.replace("x86_64", "x64").replace("darwin", "osx").replace("aarch64", "aarch64sbsa")

...
class RBsgenomeAmelliferaNcbiAmelhav31(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Amellifera.NCBI.AmelHAv3.1_1.5.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Amellifera.NCBI.AmelHAv3.1/BSgenome.Amellifera.NCBI.AmelHAv3.1_1.5.0.tar.gz"]

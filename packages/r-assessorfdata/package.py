...
class RAssessorfdata(RPackage):
	...
	bioc = "AssessORFData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/AssessORFData_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/AssessORFData/AssessORFData_1.20.0.tar.gz"]

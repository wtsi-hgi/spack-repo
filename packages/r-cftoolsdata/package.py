...
class RCftoolsdata(RPackage):
	...
	bioc = "cfToolsData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/cfToolsData_1.0.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/cfToolsData/cfToolsData_1.0.0.tar.gz"]

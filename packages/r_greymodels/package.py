...
class RGreymodels(RPackage):
	...
	homepage = "https://github.com/havishaJ/Greymodels"
	cran = "Greymodels" 

	version("2.0.1", md5="c8dbba223e2fbfc52e568a95ee28db7d")
	...
	depends_on("r-particle-swarm-optimisation", type=("build", "run"))

...
class RPolyphenHsapiensDbsnp131(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/PolyPhen.Hsapiens.dbSNP131_1.0.2.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/PolyPhen.Hsapiens.dbSNP131/PolyPhen.Hsapiens.dbSNP131_1.0.2.tar.gz"]

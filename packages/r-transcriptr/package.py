...
class RTranscriptr(RPackage):
	...
	bioc = "transcriptR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/transcriptR_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/transcriptR/transcriptR_1.30.0.tar.gz"]

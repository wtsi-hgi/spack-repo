...
class RIlluminahumanmethylationepicannoIlm10b3Hg19(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/IlluminaHumanMethylationEPICanno.ilm10b3.hg19_0.6.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/IlluminaHumanMethylationEPICanno.ilm10b3.hg19/IlluminaHumanMethylationEPICanno.ilm10b3.hg19_0.6.0.tar.gz"]

	version("0.6.0", md5="2dac8e889486386eaea1bb7ce1beea2e", url="https://www.bioconductor.org/packages/release/data/annotation/src/contrib/IlluminaHumanMethylationEPICanno.ilm10b3.hg19_0.6.0.tar.gz")

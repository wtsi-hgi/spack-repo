...
class RBsgenomeGaculeatusUcscGasacu1Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Gaculeatus.UCSC.gasAcu1.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Gaculeatus.UCSC.gasAcu1.masked/BSgenome.Gaculeatus.UCSC.gasAcu1.masked_1.3.99.tar.gz",
    ]

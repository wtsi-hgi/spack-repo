...
class RLactcurves(RPackage):
	"""Lactation Curve Parameter Estimation

	AllCurves() runs multiple lactation curve models and extracts selection criteria for each model.
  ...
  F-value (F) based on F-ratio test.
	...
	version("1.1.0", md5="e5fec9958137c47d62c65954b342c39d")

...
class RBsgenomeGgallusUcscGalgal4(RPackage):
	...
	version("1.4.0", sha256="f6c52ea77b0e3d3582df99d6967eeb753dadf5082cdf17bf1ac4b5a90c01d4e1", url="https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Ggallus.UCSC.galGal4_1.4.0.tar.gz")

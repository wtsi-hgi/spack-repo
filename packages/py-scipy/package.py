...
class PyScipy(PythonPackage):
    ...
    depends_on("python@3.5:3.10", when="@1.7.2:1.7", type=("build", "link", "run"))
    depends_on("python@3.5:3.9", when="@1.5.4:1.7.1", type=("build", "link", "run"))
    depends_on("python@3.5:3.8", when="@1.3.2:1.5.3", type=("build", "link", "run"))
    depends_on("python@3.5:3.7", when="@1.3.0:1.3.1", type=("build", "link", "run"))
    depends_on("python@2.7,3.5:3.7", when="@:1.3", type=("build", "link", "run"))
    ...
    depends_on("py-cython@3:", when="@1.12:", type="build")
    ...
    depends_on("py-pybind11@2.12.0:", when="@1.12:", type=("build", "link"))
    ...
    depends_on("py-pybind11@2.4.3:2.6", when="@1.5:1.6.1", type=("build", "link"))
    depends_on("py-pybind11@2.4.0:2.6", when="@1.4.1:1.4", type=("build", "link"))
    depends_on("py-pybind11@2.2.4:2.6", when="@1.4.0", type=("build", "link"))
    depends_on("py-pythran@0.15:", when="@1.11:^python@3.12:", type="build")
    ...
    def config_settings(self, spec, prefix):
        ...
        return {
            ...
            "setup-args": {
                ...
                "-Dblas": blas.replace("_", ""),  # fix a mismatch between libary name and pkg-config name
                "-Dlapack": lapack.replace("_", ""),
            },
        }

...
class RBsgenomeAmelliferaUcscApimel2Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Amellifera.UCSC.apiMel2.masked_1.3.99.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Amellifera.UCSC.apiMel2.masked/BSgenome.Amellifera.UCSC.apiMel2.masked_1.3.99.tar.gz",
    ]

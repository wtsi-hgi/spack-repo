...
class PyNodeenv(PythonPackage):
    ...
    # nodeenv <=1.8.0 imports pkg_resources which was removed in setuptools 71
    depends_on("py-setuptools@:70", when="@:1.8", type=("build", "run"))
    depends_on("py-setuptools", when="@1.9:", type=("build", "run"))

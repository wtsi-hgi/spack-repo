...
class RRecoup(RPackage):
	...
	bioc = "recoup" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/recoup_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/recoup/recoup_1.30.0.tar.gz"]

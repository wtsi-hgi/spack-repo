...
class RMogene11sttranscriptclusterDb(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/mogene11sttranscriptcluster.db_8.8.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/mogene11sttranscriptcluster.db/mogene11sttranscriptcluster.db_8.8.0.tar.gz"]

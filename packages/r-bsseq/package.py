...
class RBsseq(RPackage):
	...
	bioc = "bsseq"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/bsseq_1.38.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/bsseq/bsseq_1.38.0.tar.gz"]

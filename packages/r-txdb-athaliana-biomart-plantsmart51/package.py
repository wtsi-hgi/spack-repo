...
class RTxdbAthalianaBiomartPlantsmart51(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/TxDb.Athaliana.BioMart.plantsmart51_0.99.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/TxDb.Athaliana.BioMart.plantsmart51/TxDb.Athaliana.BioMart.plantsmart51_0.99.0.tar.gz"]

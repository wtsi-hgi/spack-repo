...
class PyGpytorch(PythonPackage):
    ...
    pypi = "gpytorch/gpytorch-1.15.2.tar.gz"

    maintainers("adamjstewart", "meyersbs")

    license("MIT")

    version("1.15.2", sha256="380625e93f851b85f772b25c5fb0a6c6d2e3eb2ef667f1e566ab4f95b8775361")
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-linear-operator@0.6.1:", when="@1.13:")

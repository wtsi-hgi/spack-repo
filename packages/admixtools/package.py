...
class Admixtools(MakefilePackage):
    ...
    build_directory = "src"
    parallel = False  # nicksrc must finish before binaries link against libnick
    ...
    def install_test(self):
        """Basic CLI smoke test to ensure binaries run."""
        Executable(join_path(self.prefix.bin, "grabpars"))()

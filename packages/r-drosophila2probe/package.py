...
class RDrosophila2probe(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/drosophila2probe_2.18.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/drosophila2probe/drosophila2probe_2.18.0.tar.gz",
    ]

...
class RIpac(RPackage):
	...
	bioc = "iPAC" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/iPAC_1.46.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/iPAC/iPAC_1.46.0.tar.gz"]

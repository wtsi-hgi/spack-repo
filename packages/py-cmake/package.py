...
class PyCmake(PythonPackage):
    ...
    version("3.31.1", sha256="45e09ef6fc5a0d3d4cac11bfee43ba3f9925f301660630d3d1e5457fbe12ecdf")
    ...
    depends_on("py-scikit-build@0.12:", type="build", when="@:3.31.1")
    depends_on("py-setuptools@42:", type="build", when="@:3.37.8")
    depends_on("py-scikit-build-core", type="build", when="@3.31.1:")
    depends_on("py-scikit-build-core@0.10:", type="build", when="@4:")
    # in newer pip versions --install-option does not exist
    depends_on("py-pip@:23.0", type="build")
    depends_on("git", type="build")
    depends_on("cmake@3.31.1", type=("build", "link", "run"), when="@3.31.1")
    ...
    for v in ["3.31.1", "3.27.7", "3.22.2", "3.21.4", "3.18.0"]:
        resource(
            name="cmake-src",

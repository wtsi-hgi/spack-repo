...
class REsetvis(RPackage):
	...
	bioc = "esetVis" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/esetVis_1.28.2.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/esetVis/esetVis_1.28.2.tar.gz"]

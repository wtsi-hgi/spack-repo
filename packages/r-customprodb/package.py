...
class RCustomprodb(RPackage):
	...
	bioc = "customProDB" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/customProDB_1.41.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/customProDB/customProDB_1.41.0.tar.gz"]

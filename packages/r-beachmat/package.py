...
class RBeachmat(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/bioc/src/contrib/beachmat_2.18.1.tar.gz",
    ...
    version("2.18.1", sha256="54cc8e943c607012c9760814b0305b8ad75a083f54a4d6c2dc3063358795e8cf")

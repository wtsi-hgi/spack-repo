...
class PyJaxlib(PythonPackage, CudaPackage):
    ...
    # ROCm-specific dependencies omitted in this copy
    ...
    with default_args(type=("build", "run")):
        ...
        # no ROCm-specific Python upper-bound
    ...
    # external CUDA noted as unsupported upstream, but enable CUDA builds here
    # to support local CUDA-enabled builds of jaxlib >= 0.4.32.

    # aarch64 is not supported https://github.com/jax-ml/jax/issues/25598
    conflicts("target=aarch64:", when="@0.4.32:")

    # ROCm-specific XLA resource omitted
    ...
    def setup_build_environment(self, env) -> None:
        spec = self.spec
        # no ROCm-specific environment needed
    ...
    def install_test(self):
        with working_dir("spack-test", create=True):
            # jaxlib has no CLI; verify Python import works

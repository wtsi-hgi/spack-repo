...
class RHilbertvis(RPackage):
	...
	bioc = "HilbertVis" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HilbertVis_1.60.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HilbertVis/HilbertVis_1.60.0.tar.gz"]

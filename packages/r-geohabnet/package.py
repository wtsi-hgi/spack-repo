...
class RGeohabnet(RPackage):
    ...
    c) Because the geohabnet package allows R users to provide maps of cropland density (as originally in Xing et al (2021)), host landscape density (representing the geographic distribution of either crops or wild species), or habitat distribution (such as host landscape density adjusted by climate suitability) as inputs, we propose the term habitat connectivity.
	...
	version("2.0.0", md5="8c6c42497735feb17fb7e4fd0628ae91")

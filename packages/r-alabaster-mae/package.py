...
class RAlabasterMae(RPackage):
	...
	bioc = "alabaster.mae" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/alabaster.mae_1.2.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/alabaster.mae/alabaster.mae_1.2.0.tar.gz"]

...
class NfCoreTools(PythonPackage):
    ...
    depends_on("python@3.10:", type=("build", "run"), when="@3.5.2:")
    ...
    depends_on("py-jsonschema@3.0:", type=("build", "run"), when="@3.5.2:")
    ...
    depends_on("py-prompt-toolkit@:3.0.52", type=("build", "run"), when="@3.5.2:")
    depends_on("py-pytest@7.0.0:", type=("build", "run"))
    depends_on("py-pytest-workflow@1.6.0:", type=("build", "run"))
    depends_on("py-pydantic@2.2.1:", type=("build", "run"), when="@3.5.2:")
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-questionary@1.8.0:", type=("build", "run"))
    depends_on("py-questionary@2.0.1:", type=("build", "run"), when="@3.5.2:")
    ...
    depends_on("py-rich-click@1.9:1.10", type=("build", "run"), when="@3.5.2:")
    depends_on("py-rich@10.7.0:", type=("build", "run"))
    depends_on("py-rich@13.3.1:", type=("build", "run"), when="@3.5.2:")
    depends_on("py-rocrate", type=("build", "run"), when="@3.5.2:")
    depends_on("py-repo2rocrate", type=("build", "run"), when="@3.5.2:")
    depends_on("py-tabulate", type=("build", "run"))
    depends_on("py-textual@7.4.0", type=("build", "run"), when="@3.5.2:")
    depends_on("py-trogon", type=("build", "run"), when="@3.5.2:")
    depends_on("py-pdiff", type=("build", "run"), when="@3.5.2:")
    depends_on("py-ruamel-yaml", type=("build", "run"), when="@3.5.2:")

    def patch(self):
        filter_file('license = "MIT"', 'license = {text = "MIT"}', "pyproject.toml")

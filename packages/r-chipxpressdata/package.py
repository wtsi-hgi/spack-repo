...
class RChipxpressdata(RPackage):
	...
	bioc = "ChIPXpressData" 
	urls = ["https://www.bioconductor.org/packages/release/data/experiment/src/contrib/ChIPXpressData_1.40.0.tar.gz", "https://www.bioconductor.org/packages/release/data/experiment/src/contrib/Archive/ChIPXpressData/ChIPXpressData_1.40.0.tar.gz"]

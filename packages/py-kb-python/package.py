...
class PyKbPython(PythonPackage):
    ...
    version(
        "0.29.5",
        sha256="24141916807c8dd41484e5e9d7710df92e1386b77cf5dafa10f06d106b88b8a9",
        expand=False,
        url="https://files.pythonhosted.org/packages/be/dc/549f2de517272abda9f4169d70bf2c1268a4f0ce159901a0d8c1c9e6d10b/kb_python-0.29.5-py3-none-any.whl",
        preferred=True,
    )

    depends_on("py-setuptools", type=("build"))
    depends_on("python@3.8:", type=("build", "run"))
    # Core dependencies (base bounds from PyPI metadata across versions)
    ...
    depends_on("py-pandas@1.5.3:", when="@0.29.0:", type=("build", "run"))
    depends_on("py-typing-extensions@3.7.4:", when="@0.29.0:", type=("build", "run"))
    depends_on("py-biopython@1.8:", when="@0.29.0:", type=("build", "run"))

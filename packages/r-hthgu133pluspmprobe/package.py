...
class RHthgu133pluspmprobe(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/hthgu133pluspmprobe_2.18.0.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/hthgu133pluspmprobe/hthgu133pluspmprobe_2.18.0.tar.gz",
    ]

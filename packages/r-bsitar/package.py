...
Curve Analysis
    ...
    (2010) <doi:10.1093/ije/dyq115> for further details). The non-Bayesian version 
    of the SITAR model can be fit by using an already available R package 'sitar'. 
    ...
    of various growth curves such as distance (increase in size with age) and velocity 

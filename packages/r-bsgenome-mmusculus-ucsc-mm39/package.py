...
class RBsgenomeMmusculusUcscMm39(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/BSgenome.Mmusculus.UCSC.mm39_1.4.3.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/BSgenome.Mmusculus.UCSC.mm39/BSgenome.Mmusculus.UCSC.mm39_1.4.3.tar.gz"]

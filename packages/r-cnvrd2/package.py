...
class RCnvrd2(RPackage):
	...
	bioc = "CNVrd2" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/CNVrd2_1.40.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/CNVrd2/CNVrd2_1.40.0.tar.gz"]

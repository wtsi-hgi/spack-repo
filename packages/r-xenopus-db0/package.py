...
class RXenopusDb0(RPackage):
	...
	bioc = "xenopus.db0" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/xenopus.db0_3.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/xenopus.db0/xenopus.db0_3.18.0.tar.gz"]

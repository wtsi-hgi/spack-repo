...
class RGetdee2(RPackage):
	...
	bioc = "getDEE2" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/getDEE2_1.12.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/getDEE2/getDEE2_1.12.0.tar.gz"]

...
class RHu35ksubdDb(RPackage):
	...
	bioc = "hu35ksubd.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/hu35ksubd.db_3.13.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/hu35ksubd.db/hu35ksubd.db_3.13.0.tar.gz"]

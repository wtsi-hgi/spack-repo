...
class RA4preproc(RPackage):
	...
	bioc = "a4Preproc"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/a4Preproc_1.50.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/a4Preproc/a4Preproc_1.50.0.tar.gz"]

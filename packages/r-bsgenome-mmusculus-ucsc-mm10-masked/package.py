...
class RBsgenomeMmusculusUcscMm10Masked(RPackage):
    ...
    urls = [
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/BSgenome.Mmusculus.UCSC.mm10.masked_1.4.3.tar.gz",
        "https://www.bioconductor.org/packages/3.18/data/annotation/src/contrib/Archive/BSgenome.Mmusculus.UCSC.mm10.masked/BSgenome.Mmusculus.UCSC.mm10.masked_1.4.3.tar.gz",
    ]

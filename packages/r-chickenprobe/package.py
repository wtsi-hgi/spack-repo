...
class RChickenprobe(RPackage):
	...
	bioc = "chickenprobe" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/chickenprobe_2.18.0.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/chickenprobe/chickenprobe_2.18.0.tar.gz"]

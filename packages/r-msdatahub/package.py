...
class RMsdatahub(RPackage):
	...
	bioc = "MsDataHub" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MsDataHub_1.2.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MsDataHub/MsDataHub_1.2.0.tar.gz"]

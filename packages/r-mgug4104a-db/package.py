...
class RMgug4104aDb(RPackage):
	...
	bioc = "mgug4104a.db" 
	urls = ["https://www.bioconductor.org/packages/release/data/annotation/src/contrib/mgug4104a.db_3.2.3.tar.gz", "https://www.bioconductor.org/packages/release/data/annotation/src/contrib/Archive/mgug4104a.db/mgug4104a.db_3.2.3.tar.gz"]

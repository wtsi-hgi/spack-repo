...
class RCausalr(RPackage):
	...
	bioc = "CausalR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/CausalR_1.34.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/CausalR/CausalR_1.34.0.tar.gz"]
